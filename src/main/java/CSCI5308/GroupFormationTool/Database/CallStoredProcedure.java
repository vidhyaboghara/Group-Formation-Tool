...
public class CallStoredProcedure
{
	...
	private static final Logger logger = Logger.getLogger(CallStoredProcedure.class);
	...
	public void cleanup()
	{
		...
		{
			logger.error("Error in closing database connections after executing " + storedProcedureName);
		}
	}
